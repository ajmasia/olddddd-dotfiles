...
_xfunc git __git_complete gp _git_pull
_xfunc git __git_complete gf _git_fetch
_xfunc git __git_complete gps _git_push
...
_xfunc git __git_complete grb _git_rebase
_xfunc git __git_complete glg _git_log
